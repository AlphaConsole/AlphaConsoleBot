...
module.exports = {
  ...
  run: ({ client, serverInfo, message, args, sql, config, sendEmbed }) => {
    ...
    if (args.length < 2)
      return sendEmbed(
        message.channel,
        "You must have forgotten the user",
        "`!Checkdb <@tag | user Id>`"
      );
          ...
          sql.query(
            ...
            (err, steams) => {
              ...
              sendEmbed(
                ...
                }\n**[All details of this user](http://staff.alphaconsole.net/details/${
                  user.DiscordID
                })**`,
                undefined,
                undefined,
